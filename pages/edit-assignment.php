		...
		<div class="main-content">
			<div class="card">
				...
				<div class="card-content">
					<form id="form-account" class="form" method="post" action="assignment.php">
						<div class="input-group">
							<div class="input-label" style="display: flex; align-items: flex-start;">
								<label class="text-label">Title</label>
							</div>
							<div class="form-control">
								<input type="text" id="input-title" class="form-input success" name="title" value="Assignment 1">
							</div>
						</div>
						<div class="input-group">
							<div class="input-label" style="display: flex; align-items: flex-start;">
						...
						<div class="input-group">
							...
							<div class="form-control">
								...
								<input type="date" id="input-date-picker" name="date-picker" value="2021-06-30">
							</div>
						</div>
						<div class="input-group">
							<div class="input-label">
							...
							<div class="form-control">
								...
								<input type="time" id="input-time-picker" name="time-picker" value="23:59">
							</div>
						</div>
				</div>
