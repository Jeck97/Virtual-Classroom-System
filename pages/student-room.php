		...
		<div class="main-content">
			<div class="card">
				...
				<div class="card-content">
					<div style="width: 100%; height: 300px; display: block; display: flex; align-items: center; justify-content: center;">
						<div style="width: 250px; height: 250px;">
							<img src="../img/james-harden.jpg" style="width: 250px; height: 250px; border-radius: 50%;">
						</div>
					</div>
				</div>
				<div class="card-footer">
					...
					<button class="btn btn-secondary" name="start-meeting" value="start-meeting">Join Meeting</button>
				</div>
			</div>
		</form>
		</div>	
