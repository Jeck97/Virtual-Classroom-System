			...
			<div class="card">
				<form id="form-account" method="post" action="../controller/manager/account-manager.php" enctype="multipart/form-data">
					...
					<div class="card-footer">
						<input style="display: none;" type="submit" name="submit" value="update-name-pic"></input>
						<button class="btn btn-danger" type="submit" name="submit" value="deactive-account">Deactive Account</button>
