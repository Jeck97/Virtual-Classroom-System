	...
	if (isset($_POST['submit'])) {
		...
		if ($_POST['submit'] === "register") {
			...
			if ($auth->isExist($email) != false) {
				...
				$link = "http://localhost/Virtual-Classroom-System-v1.3/pages/email-verified.php?email=".$email."&key=".$key."&action=".$action;
		...
		if ($_POST['submit'] === "forgot") {
			...
			if ($account != false) {
				...
				$output = "http://localhost/Virtual-Classroom-System-v1.3/pages/reset-password.php?key=".$key."&email=".$email."&action=".$action;
