<?php  
	...
	function enrollChannel($student, $channel){
		$query = "INSERT INTO student_channel (student, channel) VALUES (?,?)";
		$result = $this->db->runInsertUpdate($query, 'ss', array ($student, $channel));
		return $result;
